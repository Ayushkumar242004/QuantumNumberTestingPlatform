...
// This function dynamically fetches pValue and result for binary data
export const useFrequencyTestData = (binaryData) => {
  ...
  useEffect(() => {
    const fetchFrequencyTestData = async () => {
      try {
        ...
        console.log('hello fre', response);
    ...
    if (binaryData) fetchFrequencyTestData();
  }, [binaryData]);

};

// Mock data dynamically updated
export const mockDataTeam = [
  {
    id: 1,
    name: "Frequency Test",
    result: 'random', // Default result
    pValue: 1, // Default pValue
  },
];
...
//   },
  ...
  // {
  //   id: 4,
  //   name: "Test for the longest run of ones",
  //   email: "jonsnow@gmail.com",
  //   pValue: 35,
  //   phone: "(665)121-5454",
  //   access: "admin",
  ...
  // {
  //   id: 7,
  //   name: "Non overlapping Template Match Test",
  //   email: "jonsnow@gmail.com",
  //   pValue: 35,
  //   phone: "(665)121-5454",
  //   access: "admin",
  ...
  // {
  //   id: 8,
  //   name: "Overlapping Template MatchTest",
  //   email: "jonsnow@gmail.com",
  //   pValue: 35,
  //   phone: "(665)121-5454",
  //   access: "admin",
  ...
  // {
  //   id: 15,
  //   name: "Adaptive Statistical Test",
  //   email: "jonsnow@gmail.com",
  //   pValue: 35,
  //   phone: "(665)121-5454",
  //   access: "admin",
